# /************************************************************************
 ...
 #
 #  Copyright (c) 2020 The Pirate developers
...
BUILDUSER := `whoami`
LDFLAGSSTRING :=-X github.com/AlphaX-Projects/lightwalletd/common.Version=$(VERSION)
LDFLAGSSTRING +=-X github.com/AlphaX-Projects/lightwalletd/common.GitCommit=$(GITCOMMIT)
LDFLAGSSTRING +=-X github.com/AlphaX-Projects/lightwalletd/common.Branch=$(BRANCH)
LDFLAGSSTRING +=-X github.com/AlphaX-Projects/lightwalletd/common.BuildDate=$(BUILDDATE)
LDFLAGSSTRING +=-X github.com/AlphaX-Projects/lightwalletd/common.BuildUser=$(BUILDUSER)
