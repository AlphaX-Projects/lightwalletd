...
git remote add upstream git@github.com:pirate/lightwalletd.git
...
[remote "upstream"]
	url = git@github.com:pirate/lightalletd.git
...
upstream    git@github.com:pirate/lightwalletd.git (fetch)
...
[remote "origin"]
	...
	fetch = +refs/heads/*:refs/remotes/origin/*
[remote "upstream"]
	url = git@github.com:pirate/lightwalletd.git
	fetch = +refs/heads/*:refs/remotes/upstream/*
	pushurl = DISABLED
```
